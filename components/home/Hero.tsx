...
function Hero() {
  return (
    <section className='grid grid-cols-1 lg:grid-cols-2 gap-24 items-center'>
      <div>
        <h1 className='max-w-2xl font-bold text-4xl tracking-tight sm:text-6xl text-primary-foreground'>
          Heaven & Hue
        </h1>
        <h3 className='max-w-2xl font-semibold text-4xl tracking-tight sm:text-6xl'>
